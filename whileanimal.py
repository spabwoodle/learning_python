...
def to_message(input_habitat):
   if int(input_habitat) == 0:
      return camel
   elif int(input_habitat) == 1:
      return lion
   elif int(input_habitat) == 2:
      return deer
   elif int(input_habitat) == 3:
      return goose
   elif int(input_habitat) == 4:
      return bat
   elif int(input_habitat) == 5:
      return rabbit

input_habitat = input("Which habitat # do you need?")
while input_habitat != "exit":
  print(to_message(input_habitat))
  input_habitat = input("Which habitat # do you need?")
print("See you!")